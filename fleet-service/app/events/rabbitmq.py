...
# cola suscrita en el exchange. A los que nadie consume NO se les aplica
# `mandatory`: el broker los devolvería siempre y el relay los retendría como
# "no enrutable" sin remedio (mismo caso que telemetry.raw en Tracking).
EVENTOS_CON_CONSUMIDORES = {
    "vehicle.status_changed",  # routing-service (routing.inbox)
}
